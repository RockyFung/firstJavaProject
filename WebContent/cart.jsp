...
<html>
	<head>
		...
		<script type="text/javascript">
			function deleteProductByPid(pid){
				if(confirm("是否删除该商品")){
					location.href="${pageContext.request.contextPath}/product?method=deleteProductByPid&pid="+pid;
				}
			}
		function clearCart(){
			if(confirm("是否清除购物车")){
						...
						<tbody>
							...
							<c:forEach items="${cart.cartItems}" var="entry">
								<tr class="active">
									...
									<td>
										<a href="javascript:;" class="delete" onclick="deleteProductByPid('${entry.value.product.pid}')">删除</a>
									</td>
								</tr>
							</c:forEach>
